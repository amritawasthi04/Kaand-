              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      ...
                      Text(
                        _currentArticle.publishedAt != null && _currentArticle.publishedAt!.length >= 10
                            ? '${_currentArticle.publishedAt!.substring(0, 10)} • ${_currentArticle.readTime ?? 3} min read'
                            : '${_currentArticle.readTime ?? 3} min read',
                        style: const TextStyle(
                          color: AppColors.mutedText,
                          fontSize: 13,
                        ),
                  ...
                  if (_isLoading && (_currentArticle.content == null || _currentArticle.content!.isEmpty))
                    ...
                    Text(
                      _currentArticle.content ?? _currentArticle.description ?? 'No content available.',
                      style: const TextStyle(
                        fontSize: 15,
